...
Discente.getInitialProps = ({ query: { user } }) => {
  return { user }
}

export default function Discente({user}) {
    ...
    return (
      <>
        ...
        >
          ...
          <div style={{ width: "300px", textAlign: "left" }}>
            {turma.media ? turma.media : "Média ainda não lançada"}
          </div>
        </li>
      </>
    );
      ...
      >
        <table style={{ width: "100%" }}>
          ...
          >
            ...
            <td style={{ width: "300px", textAlign: "left" }}>Professor</td>
            <td style={{ width: "300px", textAlign: "left" }}>Média</td>
          </tr>
          {listaTurmas}
          <br />
        </table>
...
function Usuario(props) {
  const [aluno, setAluno] = React.useState([props.username]);
